...
CU110_SLAB = create_slab(crystal=BULK_Cu, miller_indices=(1, 1, 0), number_of_layers=1, vacuum=10.0)
MOS2_MONOLAYER = Material.create(Materials.get_by_name_and_categories("MoS2", "2D"))
